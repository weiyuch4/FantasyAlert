...
import { Dimensions, Platform, StyleSheet, Text, Image, TouchableOpacity, View, ScrollView, Keyboard } from 'react-native';
...
const SearchApp = (props) => {
	...
	const addPlayer = (playerName, playerTeam, playerIcon) => {
		if (data.followed[playerName]) {
			...
			data.setFollowed({...data.followed, [playerName]: [playerTeam, playerIcon]});
		}
	};
		...
		return (
			<View style={styles.playerView}>
				...
				<View style={styles.playerText}>
					...
					<TouchableOpacity 
						onPress={() => addPlayer(Object.keys(item)[0], Object.values(item)[0][0], Object.values(item)[0][1])}
						style={styles.button}
					>
			...
			<SafeAreaView style={styles.headerSafeArea}>
				<View style={styles.header}>
					<View style={styles.headerInner}>
						...
						<Animated.View
							style={[ styles.inputBox, {transform: [{translateX: inputBoxTranslateX}]}]}
						>
